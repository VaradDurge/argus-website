  ...
  return (
    <header
      className={cn(
        ...
        {
          "bg-background/65 supports-[backdrop-filter]:bg-background/35 backdrop-blur-lg md:top-4 md:max-w-4xl md:shadow": scrolled && !open,
    ...
    >
      ...
      >
        <Link href="/" aria-label="Argus home" className="min-w-[132px] text-sm font-semibold tracking-[-0.02em] text-white/80">
          ARGUS
        </Link>
        ...
        <div className="hidden min-w-[132px] items-center justify-end md:flex">
          <ButtonCta className="h-9 px-4" onClick={() => router.push("/waitlist")} />
        </div>
...
export const WordmarkIcon = (props: React.ComponentProps<"svg">) => (
  <svg viewBox="0 0 84 24" fill="currentColor" aria-label="Argus" role="img" {...props}>
